...
'    end) "Absent with M/C",',
'subject_status',
'-- FROM v_attendancelist_summary va,',
...
||'HECKIN_BY:REMARKS:LECTURER_NAME:LECTURER_IC_PASSPORT:LECTURER_PHONE:LECTURER_EMAIL:Absent with M/C:'
);
wwv_flow_imp_page.create_worksheet_rpt(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(846186239624009742)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(846186279919009743)
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_show_nulls_as=>'-'
...
,p_enable_mail_download=>'Y'
,p_owner=>'MUZA'
,p_internal_uid=>876418318577792021
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846186402239009744)
,p_db_column_name=>'STUDENT_NAME'
,p_display_order=>10
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846186493419009745)
,p_db_column_name=>'IC_PASSPORT'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'IC Passport'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846186578251009746)
,p_db_column_name=>'COURSE_CODE'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Programme Code'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846186756386009747)
,p_db_column_name=>'STUDY_INTAKE'
,p_display_order=>40
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846186788462009748)
,p_db_column_name=>'ACADEMIC_SEMESTER'
,p_display_order=>50
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846186940937009749)
,p_db_column_name=>'SUBJECT_CODE'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'Course Code'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846186996563009750)
,p_db_column_name=>'E_MAIL'
,p_display_order=>70
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846187230995009752)
,p_db_column_name=>'STUDENT_MOBILE_NO'
,p_display_order=>90
,p_column_identifier=>'H'
,p_column_label=>'Mobile No'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846187328865009753)
,p_db_column_name=>'CLASS_SESSION'
,p_display_order=>100
,p_column_identifier=>'I'
,p_column_label=>'Class Session'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846187416082009754)
,p_db_column_name=>'ATTENDANCE_DATE'
,p_display_order=>110
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846187461983009755)
,p_db_column_name=>'TIME_FROM'
,p_display_order=>120
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846187599151009756)
,p_db_column_name=>'TIME_TO'
,p_display_order=>130
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846187707465009757)
,p_db_column_name=>'ATTENDED'
,p_display_order=>140
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846187815459009758)
,p_db_column_name=>'LATE'
,p_display_order=>150
,p_column_identifier=>'N'
,p_column_label=>'Late'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846187880968009759)
,p_db_column_name=>'VALID_REASON'
,p_display_order=>160
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846188024100009760)
,p_db_column_name=>'REMARKS'
,p_display_order=>170
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846188073393009761)
,p_db_column_name=>'LECTURER_NAME'
,p_display_order=>180
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846188206171009762)
,p_db_column_name=>'LECTURER_IC_PASSPORT'
,p_display_order=>190
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846188261502009763)
,p_db_column_name=>'LECTURER_PHONE'
,p_display_order=>200
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846188418391009764)
,p_db_column_name=>'LECTURER_EMAIL'
,p_display_order=>210
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846188484466009765)
,p_db_column_name=>'SCM_STUDENT_NUMBER'
,p_display_order=>220
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846188621360009766)
,p_db_column_name=>'CHECK_IN'
,p_display_order=>230
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846188708018009767)
,p_db_column_name=>'CHECKIN_BY'
,p_display_order=>240
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846188786902009768)
,p_db_column_name=>'RESOURCE_NAME'
,p_display_order=>250
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846189001609009770)
,p_db_column_name=>'SUBJECT_STATUS'
,p_display_order=>270
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(846189077141009771)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7030826998894074)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7030643189894073)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7030623906894072)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7030444610894071)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7030285134894069)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7030141349894068)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(6611272551517175)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(6611173420517174)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(657333752713196746)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'6875658'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
||'AIL:SCM_STUDENT_NUMBER:CHECK_IN:CHECKIN_BY:RESOURCE_NAME:SUBJECT_STATUS:ABSENT_WITH_MC'
);
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(641144154106127023)
,p_event_id=>wwv_flow_imp.id(377579496163717522)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(846186239624009742)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
